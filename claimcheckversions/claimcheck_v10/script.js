...
const insurerLogoWall = document.getElementById("insurers");
const firstStepSections = Array.from(document.querySelectorAll(".first-step-only"));
...
const text = {
  language: "Language",
  heroTag: "Choose Your Pathway",
  slogan: "What would you like to check today?",
  subtext: "Start with a quick consultation check or compare plans that may better match your needs.",
  restart: "Restart",
  back: "Back",
  result: "Result",
  sample: "SAMPLE",
  medicareCardCaption: "This is a sample Medicare card. Your real card may be physical or digital in the myGov app.",
...
const insurers = {
  medibank: {
    name: "Medibank",
    logo: "assets/health-insurers/medibank.png",
    fallback: "M",
  ...
  bupa: {
    name: "Bupa",
    logo: "assets/health-insurers/bupa.png",
    fallback: "B",
  ...
  hcf: {
    name: "HCF",
    logo: "assets/health-insurers/hcf.png",
    fallback: "HCF",
  ...
  nib: {
    name: "nib",
    logo: "assets/health-insurers/nib.png",
    fallback: "nib",
  ...
  ahm: {
    name: "ahm",
    logo: "assets/health-insurers/ahm.png",
    fallback: "ahm",
  ...
  australianUnity: {
    ...
    logo: "assets/health-insurers/australian-unity.png",
    fallback: "AU",
...
function updateFirstStepSections() {
  const shouldShow = currentStep === "medicare";
  firstStepSections.forEach((section) => {
...
function renderMedicareSampleCard() {
  ...
  questionVisual.innerHTML = `
    <div class="medicare-sample-card" aria-label="Sample Medicare card">
      <img
        class="medicare-card-img"
        src="assets/logos/medicare-card.jpg"
        alt="Sample Medicare card"
        onerror="this.style.display='none'; this.nextElementSibling.classList.remove('hidden');"
      />
      <div class="medicare-card-fallback hidden">
        <strong>Medicare</strong>
        <span>${text.sample}</span>
        <small>Jane Citizen · 2000 00000 0</small>
      </div>
    </div>
...
function updateStaticEnglishText() {
  setTextContent(languageLabel, text.language);
  setTextContent(heroTag, text.heroTag);
  setTextContent(heroSlogan, text.slogan);
  setTextContent(heroSubtext, text.subtext);
  setTextContent(restartText, text.restart);
  setTextContent(backText, text.back);
  setTextContent(smallPrintText, text.smallPrint);
}
